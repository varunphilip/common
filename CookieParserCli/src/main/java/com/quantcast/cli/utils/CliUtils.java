...
public class CliUtils {
	...
	public void printResult() throws Exception {
		if (CookieParserCliMain.results == null) {
			return;
		} else if (CookieParserCliMain.results instanceof String)
			System.out.println(CookieParserCliMain.results);
		else if (CookieParserCliMain.results instanceof Integer)
			System.out.println(CookieParserCliMain.results);
		else if (CookieParserCliMain.results instanceof List<?>)
			for (Object cookie : (List<?>) CookieParserCliMain.results) {
	...
	public List<String> findActiveCookies() throws Exception {
		...
		int frequency = 0;
		for (CookieVo vo : (List<CookieVo>) CookieParserCliMain.results) {
